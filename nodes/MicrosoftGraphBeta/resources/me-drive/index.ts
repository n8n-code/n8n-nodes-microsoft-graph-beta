...
export const meDriveDescription: INodeProperties[] = [
		{
		...
		{
			"displayName": "GET /me/drives/{drive-id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
