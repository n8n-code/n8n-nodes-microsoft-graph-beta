...
export const servicePrincipalsOAuth2PermissionGrantDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/servicePrincipals/{{$parameter[\"servicePrincipal-id\"]}}/oauth2PermissionGrants"
						}
					}
				},
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/servicePrincipals/{{$parameter[\"servicePrincipal-id\"]}}/oauth2PermissionGrants/{{$parameter[\"oAuth2PermissionGrant-id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /servicePrincipals/{servicePrincipal-id}/oauth2PermissionGrants/{oAuth2PermissionGrant-id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
