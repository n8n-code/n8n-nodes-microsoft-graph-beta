...
export const usersPersonDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Users List People",
					"value": "Users List People",
					"action": "List people",
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/users/{{$parameter[\"user-id\"]}}/people"
						}
					}
				},
				{
					"name": "Users Get People",
					"value": "Users Get People",
					"action": "Get people from users",
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/users/{{$parameter[\"user-id\"]}}/people/{{$parameter[\"person-id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /users/{user-id}/people",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /users/{user-id}/people/{person-id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
