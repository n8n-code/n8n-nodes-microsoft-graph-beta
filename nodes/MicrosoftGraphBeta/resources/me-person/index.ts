...
export const mePersonDescription: INodeProperties[] = [
		{
			...
			"options": [
				...
				},
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/me/people/{{$parameter[\"person-id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /me/people/{person-id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
