...
export const oauth2PermissionGrantsFunctionsDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/oauth2PermissionGrants/microsoft.graph.delta()"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /oauth2PermissionGrants/microsoft.graph.delta()",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
